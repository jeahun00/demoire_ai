...
from vd.archs.freq_fft_utils import FreqDecoupleBlock2
...
class RSTB(nn.Module):
    ...
    def __init__(self,
        ...
        self.patch_unembed = PatchUnEmbed(
            img_size=img_size, patch_size=patch_size, in_chans=0, embed_dim=dim, norm_layer=None)
        self.fdb = FreqDecoupleBlock2(channels=dim, window_size=window_size[1])
...
class STAD(nn.Module):
    r""" STAD: Spatio-Temporal Adaptive Demoiréing model for Video Demoiréing.
        similar setting as PSRT
    """
